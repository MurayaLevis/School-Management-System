<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ClassFees.aspx.cs" Inherits="SchoolProject.Admin.ClassFees" %>
          ...
          <div class="row mb-3 mr-lg-5 ml-lg-5">
              <div class="col-md-6">
                  <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Record to display!"
                      AutoGenerateColumns="False" AllowPaging="True" PageSize="4" Width="1004px" Height="152px" OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="FeesId"
                      ...
                      <Columns>
                          ...
                          <asp:TemplateField HeaderText="Fees(Annual)">
                              <EditItemTemplate>
                                  <asp:TextBox ID="TextBox1" runat="server" Height="37px" Text='<%# Eval("FeesAmount") %>' CssClass="form-control" Width="160px"></asp:TextBox>
                              </EditItemTemplate>
                              <ItemTemplate>

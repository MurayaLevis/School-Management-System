<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MarksDetailsUserController.ascx.cs" Inherits="SchoolProject.MarksDetailsUserController" %>
      ...
      <div class="container p-md-4 p-sm-4">
          ...
          <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
              ...
              <div class="col-md-6">
                  ...
                  <asp:TextBox ID="txtAdm" runat="server" CssClass="form-control" placeholder="Enter Admission No" required>
                  </asp:TextBox>
              </div>
          </div>
